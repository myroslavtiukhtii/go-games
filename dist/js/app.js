(() => {
    ...
    function menuInit() {
        if (document.querySelector(".header__burger")) document.addEventListener("click", (function(e) {
            if (e.target.closest(".header__burger")) document.documentElement.classList.toggle("menu-open");
            if (e.target.closest(".header__item") || e.target.closest(".page")) document.documentElement.classList.remove("menu-open");
        }));
    }
    ...
    function initSliders() {
        if (document.querySelector(".plans__swiper")) new core(".plans__swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1.1,
